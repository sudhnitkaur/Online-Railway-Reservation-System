...
public abstract class ReservationServiceImpl implements ReservationService {
    ...
    @Autowired
    private ReserveTicket reservedTicket;
    @Autowired
    ...
    public TicketStatus reserveTicket(Ticket ticket) {
        ...
        System.out.println("Journey Date : "+ticket.getDate_of_journey().toString());
    ...
    public String reserveSeat(String train_no, String class_name, LocalDate date, Long pnr) {
    	System.out.println("Journey Date : "+date.toString());
